...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Lut 2023, 11:22
...
(4, 3, '11:00', '2023-02-01', '300,299,192,191,249,248,247,91,90,89,132,130'),
...
(9, 6, '14:00', '2023-02-10', ',112,111,110,190,189,188');
...
--
ALTER TABLE `rezerwacje`
  MODIFY `IDRezerwacji` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
